$(document).ready(function() {
    ...
    var serviceTable = $('#serviceTable').DataTable({
        ...
        fixedColumns:true,
        columns: [
            { data: 'svcName', width: '220px' ,name:'first' },
            { data: 'provider', defaultContent: '' },
            { data: 'versionId' },
            { data: 'consumerName', width: '190px' },
            { data: 'domainName', width: '126px' },
            { data: 'canonicalDataModel', width: '154px', defaultContent: '' },
            { data: 'svcDescription', width: '260px' },
            { data: 'svcOperations', width: '180px', defaultContent: '' },
            { data: 'networkScope', width: '114px', defaultContent: '' },
            { data: 'eventType', width: '78px', defaultContent: '' },
            { data: 'protocol', width: '220px', defaultContent: '' },
            { data: 'svcSecurity', width: '140px', defaultContent: '' },
            { data: 'providerSLA', width: '90px', defaultContent: '' },
            { data: 'tiersSLA', width: '68px', defaultContent: '' },
            { data: 'consumerCLA', width: '108px', defaultContent: '' },
            { data: 'status', defaultContent: '' },
            { data: 'initiative', defaultContent: '' },
            { data: 'svcId', width: '70px' }
        ],
        columnDefs: [{
