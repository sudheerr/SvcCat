$(document).ready(function() {
    ...
    var serviceTable = $('#serviceTable').DataTable({
        ...
        fixedColumns:true,
        columns: [
            { data: 'serviceName', width: '200px'},
            { data: 'source', width: '90px'},
            { data: 'target', width: '90px' },
            { data: 'taxonomy', width: '120px' },
            { data: 'purpose', width: '260px' },
            { defaultContent: '',width: '80px'},
            { defaultContent: '', width: '110px' },//TODO
            { data: 'serviceType', width: '80px' },
            { data: 'transportType',defaultContent: '', width: '70px' },
            { defaultContent: '',width: '60px'},
            { data: 'serviceStatusDesc', width: '70px'},
            { defaultContent: '',width: '60px'},
            { data: 'serviceId', width: '80px' }
        ],
        columnDefs: [{
