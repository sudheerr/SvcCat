CREATE OR REPLACE PACKAGE svc_catalog_pkg  AS 
  ...
  ver_frequency IN  SVC_CAT_SERVICE_VERSION.FREQUENCY%TYPE,
...
--        INSERT INTO svc_logs( APPLICATION,LOG_LEVEL, LOG_LINE, log_text, create_user, create_date) VALUES ('ServiceCatalog', 'INFO', '1.2.2', log, user_name, sysdate);
        ...
        INSERT INTO svc_cat_service_version (svc_id, version_id, status_id,  transport_type, canonical_data_model, event_type, frequency, svc_security,additional_comments, create_user, create_date) VALUES
        (servc_id, servc_version , ver_status_id, ver_transport_type, ver_canonicalData, ver_event_type, ver_frequency, servc_security,ver_comments, user_name, sysdate);
    END;
